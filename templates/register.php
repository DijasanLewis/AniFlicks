...
<body>
    <div class="content-wrapper">
        ...
        <div class="login-form">
            <form class="form" action="../user/register_user.php" method="post">
                ...
                <div class="field">
                    ...
                    <input placeholder="Konfirmasi Password" class="input-field" type="password" name="confirm_password" required>
                </div>
                <div class="btn">
